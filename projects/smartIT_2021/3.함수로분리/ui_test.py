...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        #button
        self.button1 = Button(self.window, text="Face/Voice", command=lambda: self.func.getVideoFile(self.label6))  # flag = 1
        self.button2 = Button(self.window, text="Only Voice", command=lambda: self.func.getAudioFile(self.label7))  # flag = 2
